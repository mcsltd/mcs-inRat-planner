...
################################################################################
## Form generated from reading UI file 'main_windowEMyBbz.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxFilters = QGroupBox(self.centralwidget)
        self.groupBoxFilters.setObjectName(u"groupBoxFilters")
        self.gridLayout_3 = QGridLayout(self.groupBoxFilters)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayoutFilters = QGridLayout()
        self.gridLayoutFilters.setObjectName(u"gridLayoutFilters")
        self.labelFilterDate = QLabel(self.groupBoxFilters)
        self.labelFilterDate.setObjectName(u"labelFilterDate")

        self.gridLayoutFilters.addWidget(self.labelFilterDate, 0, 0, 1, 1)

        self.comboBoxFilterParams = QComboBox(self.groupBoxFilters)
        self.comboBoxFilterParams.setObjectName(u"comboBoxFilterParams")

        self.gridLayoutFilters.addWidget(self.comboBoxFilterParams, 0, 1, 1, 1)

        self.horizontalSpacerFilter = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayoutFilters.addItem(self.horizontalSpacerFilter, 0, 2, 1, 1)


        self.gridLayout_3.addLayout(self.gridLayoutFilters, 0, 0, 1, 1)


        self.verticalLayoutHistory.addWidget(self.groupBoxFilters)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelHistory.setText(QCoreApplication.translate("MainWindow", u"\u0417\u0430\u043f\u0438\u0441\u0438", None))
        self.pushButtonDownloadRecords.setText(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0433\u0440\u0443\u0437\u0438\u0442\u044c", None))
        self.groupBoxFilters.setTitle(QCoreApplication.translate("MainWindow", u"\u0424\u0438\u043b\u044c\u0442\u0440\u044b", None))
        self.labelFilterDate.setText(QCoreApplication.translate("MainWindow", u"\u041f\u043e \u0434\u0430\u0442\u0435 \u0437\u0430\u043f\u0438\u0441\u0438:", None))
        self.labelSchedule.setText(QCoreApplication.translate("MainWindow", u"\u0420\u0430\u0441\u043f\u0438\u0441\u0430\u043d\u0438\u044f", None))
