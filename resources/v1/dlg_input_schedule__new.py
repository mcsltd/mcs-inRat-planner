...
class Ui_DlgCreateNewSchedule(object):
    def setupUi(self, DlgCreateNewSchedule):
        ...
        DlgCreateNewSchedule.resize(493, 484)
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(30, 430, 431, 31))
        ...
        self.pushButtonByDefault = QPushButton(self.horizontalLayoutWidget)
        self.pushButtonByDefault.setObjectName(u"pushButtonByDefault")

        self.horizontalLayout_2.addWidget(self.pushButtonByDefault)
